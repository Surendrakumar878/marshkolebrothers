...
const FromCompent = () => {
  return (
    <>
         <div class=" shadow-lg  flex flex-col justify-center space-y-3 md:w-full  mb-7 md:mx-16 lg:mx-0 px-8 py-4 lg:px-4">
              ...
              <div class="flex flex-col justify-between lg:flex-col text-left space-y-1 lg:space-y-0">
                <h1>Loss/Dispute Amount</h1>
                <Input
                  name=""
                  id=""
                  cols="10"
                  rows="3"
                  class="bg-slate-100 rounded-lg px-2 py-1 placeholder:text-gray-300 w-[80%] lg:w-[60%] focus:border focus:outline-none focus:border-blue-500"
                />
              </div>
